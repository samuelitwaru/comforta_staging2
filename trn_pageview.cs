   ...
   public class trn_pageview : GXDataArea
   {
      ...
      protected void RF9C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A397Trn_PageName = H009C2_A397Trn_PageName[0];
               /* Execute user event: Load */
               E159C2 ();
      ...
      protected void E139C2( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A423PageIsPublished = H009C3_A423PageIsPublished[0];
            n423PageIsPublished = H009C3_n423PageIsPublished[0];
            AV19GXLvl9 = 1;
            Form.Caption = StringUtil.BoolToStr( A423PageIsPublished);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253262351346", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_pageview.js", "?20253262351346", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E129C2","iparms":[{"av":"AV18IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV16RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A392Trn_PageId","fld":"TRN_PAGEID"},{"av":"A397Trn_PageName","fld":"TRN_PAGENAME"},{"av":"A29LocationId","fld":"LOCATIONID"}]""");
      ...
      public override void initialize( )
      {
         ...
         H009C2_A397Trn_PageName = new string[] {""} ;
         ...
         H009C3_A423PageIsPublished = new bool[] {false} ;
         H009C3_n423PageIsPublished = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_pageview__default(),
            new Object[][] {
                new Object[] {
               H009C2_A29LocationId, H009C2_A392Trn_PageId, H009C2_A397Trn_PageName
               }
               , new Object[] {
               H009C3_A29LocationId, H009C3_A397Trn_PageName, H009C3_A392Trn_PageId, H009C3_A423PageIsPublished, H009C3_n423PageIsPublished
               }
            }
         );
