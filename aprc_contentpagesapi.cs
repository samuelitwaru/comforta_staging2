...
namespace GeneXus.Programs {
   public class aprc_contentpagesapi : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtSDT_ContentPage> aP2_SDT_ContentPageCollection )
      {
         ...
         this.AV17SDT_ContentPageCollection = new GXBaseCollection<SdtSDT_ContentPage>( context, "SDT_ContentPage", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      {
         AV17SDT_ContentPageCollection = new GXBaseCollection<SdtSDT_ContentPage>( context, "SDT_ContentPage", "Comforta_version20");
