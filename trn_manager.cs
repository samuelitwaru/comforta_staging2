...
namespace GeneXus.Programs {
   public class trn_manager : GXDataArea
   {
      ...
      protected void InitializeNonKey035( )
      {
         ...
         AssignAttri("", false, "A357ManagerPhoneCode", A357ManagerPhoneCode);
         AV30AuditingObject = new GeneXus.Programs.wwpbaseobjects.SdtAuditingObject(context);
         AV25GAMErrorResponse = "";
         AssignAttri("", false, "AV25GAMErrorResponse", AV25GAMErrorResponse);
         A24ManagerInitials = "";
         AssignAttri("", false, "A24ManagerInitials", A24ManagerInitials);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253273231781", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_manager.js", "?20253273231784", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      protected void XC_28_035( GeneXus.Programs.wwpbaseobjects.SdtAuditingObject AV30AuditingObject ,
                                Guid A21ManagerId ,
      ...
      protected void XC_29_035( GeneXus.Programs.wwpbaseobjects.SdtAuditingObject AV30AuditingObject ,
                                Guid A21ManagerId ,
                                Guid A11OrganisationId ,
                                string Gx_mode )
      {
      ...
      protected void XC_30_035( string Gx_mode ,
                                GeneXus.Programs.wwpbaseobjects.SdtAuditingObject AV30AuditingObject ,
                                Guid A21ManagerId ,
                                Guid A11OrganisationId )
      {
         if ( IsIns( )  )
      ...
      public override void initialize( )
      {
         ...
         AV28ManagerPhoneCode_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         gxphoneLink = "";
         A26ManagerPhone = "";
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV28ManagerPhoneCode_Data ;
      private GeneXus.Programs.wwpbaseobjects.SdtAuditingObject AV30AuditingObject ;
