...
namespace GeneXus.Programs.workwithplus {
   public class wwp_calendar_getevents : GXProcedure
   {
                           ...
                           out GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item> aP4_Gxm2rootcol )
      {
         ...
         this.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      public override void initialize( )
      {
         ...
         Gxm1wwp_calendar_events = new GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item(context);
         AV15GXV1 = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
         AV10CalendarEvent = new GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item(context);
         AV17GXV3 = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
         GXt_objcol_SdtWWP_Calendar_Events_Item1 = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
