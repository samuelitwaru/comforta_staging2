...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   ...
   [XmlType(TypeName =  "WWP_Form.Element" , Namespace = "Comforta_version20" )]
   [Serializable]
   ...
   [DataContract(Name = @"WorkWithPlus\DynamicForms\WWP_Form.Element", Namespace = "Comforta_version20")]
