...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   ...
   [XmlType(TypeName =  "WWP_FormInstance.Element" , Namespace = "Comforta_version20" )]
   [Serializable]
   ...
   [DataContract(Name = @"WorkWithPlus\DynamicForms\WWP_FormInstance.Element", Namespace = "Comforta_version20")]
