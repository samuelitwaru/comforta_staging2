   ...
   public class wwp_df_report : GXWebProcedure
   {
      ...
      protected void S131( )
      {
         ...
         else
         {
            ...
            H4X0( false, 57) ;
            getPrinter().GxDrawRect(0, Gx_line+15, 552, Gx_line+42, 1, 0, 0, 0, 1, 0, 128, 128, 1, 1, 1, 1, 0, 0, 0, 0) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 12, true, false, false, false, 0, 255, 255, 255, 0, 255, 255, 255) ;
            getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV39GroupTitle, "")), 20, Gx_line+18, 552, Gx_line+39, 0+16, 0, 0, 1) ;
            Gx_OldLine = Gx_line;
            Gx_line = (int)(Gx_line+57);
         }
      }
