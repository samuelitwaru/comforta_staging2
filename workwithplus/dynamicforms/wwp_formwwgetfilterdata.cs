...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_formwwgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV30GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "WorkWithPlus.DynamicForms.WWP_FormWWGridState"), null, "", "");
         }
         else
         {
         ...
         {
            AV31GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV30GridState.gxTpr_Filtervalues.Item(AV42GXV1));
