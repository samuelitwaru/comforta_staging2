...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_TrnAttributes.Transaction" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_TrnAttributes.Transaction", Namespace="Comforta_version20")]
