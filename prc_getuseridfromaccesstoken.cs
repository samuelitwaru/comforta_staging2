   ...
   public class prc_getuseridfromaccesstoken : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_gam.getStatus(0) != 101) )
         {
            ...
            A472sesapptokenexp = P00972_A472sesapptokenexp[0];
            A456userguid = P00972_A456userguid[0];
            A457sesdate = P00972_A457sesdate[0];
            A449repid = P00972_A449repid[0];
            if ( A472sesapptokenexp > DateTimeUtil.ServerNow( context, pr_default) )
            {
      ...
      public override void initialize( )
      {
         ...
         P00972_A472sesapptokenexp = new DateTime[] {DateTime.MinValue} ;
         ...
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.prc_getuseridfromaccesstoken__gam(),
            new Object[][] {
                new Object[] {
               P00972_A448sestoken, P00972_A472sesapptokenexp, P00972_A456userguid, P00972_A457sesdate, P00972_A449repid
               }
            }
         );
      ...
      private DateTime[] P00972_A472sesapptokenexp ;
   ...
   public class prc_getuseridfromaccesstoken__gam : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00972", "SELECT sestoken, sesapptokenexp, userguid, sesdate, repid FROM gam.session WHERE sestoken = ( :AV8access_token) ORDER BY sesdate DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00972,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
