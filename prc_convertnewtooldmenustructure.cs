         ...
         while ( AV24GXV1 <= AV8SDT_MenuPage.gxTpr_Rows.Count )
         {
            ...
            while ( AV25GXV2 <= AV13RowsItem.gxTpr_Tiles.Count )
            {
               ...
               if ( StringUtil.StrCmp(AV15TilesItem.gxTpr_Action.gxTpr_Objecttype, "DynamicForm") == 0 )
               {
                  ...
                  /* Using cursor P00DJ3 */
                  pr_default.execute(1, new Object[] {AV19LocationId, AV22OrganisationId, AV15TilesItem.gxTpr_Action.gxTpr_Objectid});
                  while ( (pr_default.getStatus(1) != 101) )
                  {
                     ...
                     A208WWPFormReferenceName = P00DJ3_A208WWPFormReferenceName[0];
                     new prc_logtoserver(context ).execute(  context.GetMessage( ">>> converting form url: ", "")+A208WWPFormReferenceName+":"+AV15TilesItem.gxTpr_Action.gxTpr_Objectid) ;
                     GXt_char1 = "";
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_convertnewtooldmenustructure__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00DJ3_A207WWPFormVersionNumber, P00DJ3_A11OrganisationId, P00DJ3_A29LocationId, P00DJ3_A206WWPFormId, P00DJ3_A208WWPFormReferenceName, P00DJ3_A366LocationDynamicFormId
               }
            }
         );
         /* GeneXus formulas. */
