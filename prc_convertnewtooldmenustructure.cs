...
namespace GeneXus.Programs {
   public class prc_convertnewtooldmenustructure : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            AV13RowsItem = ((SdtSDT_MenuPage_RowsItem)AV8SDT_MenuPage.gxTpr_Rows.Item(AV17GXV1));
            AV10SDT_Row = new SdtSDT_Row(context);
            AV18GXV2 = 1;
            while ( AV18GXV2 <= AV13RowsItem.gxTpr_Tiles.Count )
            {
               AV15TilesItem = ((SdtSDT_MenuPage_RowsItem_TilesItem)AV13RowsItem.gxTpr_Tiles.Item(AV18GXV2));
      ...
      private SdtSDT_MobilePage aP1_SDT_MobilePage ;
   }
