...
namespace GeneXus.Programs {
   public class prc_getpages : GXProcedure
   {
      ...
      {
         this.AV2SDT_PageCollection = new GXBaseCollection<SdtSDT_Page>( context, "SDT_Page", "Comforta_version20") ;
      ...
      {
         AV2SDT_PageCollection = new GXBaseCollection<SdtSDT_Page>( context, "SDT_Page", "Comforta_version20");
