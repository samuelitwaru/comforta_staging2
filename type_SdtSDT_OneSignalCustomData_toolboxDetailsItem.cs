...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_OneSignalCustomData.toolboxDetailsItem" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_OneSignalCustomData.toolboxDetailsItem", Namespace="Comforta_version20")]
