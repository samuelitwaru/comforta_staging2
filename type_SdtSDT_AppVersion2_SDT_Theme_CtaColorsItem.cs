...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_AppVersion2.SDT_Theme.CtaColorsItem" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_AppVersion2.SDT_Theme.CtaColorsItem", Namespace="Comforta_version20")]
