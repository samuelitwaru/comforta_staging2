...
namespace GeneXus.Programs {
   public class prc_addcalltoactionattributestosdt : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A339CallToActionId = P00DW2_A339CallToActionId[0];
            A368CallToActionName = P00DW2_A368CallToActionName[0];
      ...
      {
         AV10SDT_TrnAttributes = new SdtSDT_TrnAttributes(context);
         P00DW2_A339CallToActionId = new Guid[] {Guid.Empty} ;
         P00DW2_A368CallToActionName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_addcalltoactionattributestosdt__default(),
            new Object[][] {
                new Object[] {
               P00DW2_A339CallToActionId, P00DW2_A368CallToActionName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00DW2_A339CallToActionId ;
      private string[] P00DW2_A368CallToActionName ;
   ...
   public class prc_addcalltoactionattributestosdt__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00DW2", "SELECT CallToActionId, CallToActionName FROM Trn_CallToAction WHERE CallToActionId = :AV11CallToActionId ORDER BY CallToActionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00DW2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
