...
namespace GeneXus.Programs {
   public class prc_recurringeverystartdate : GXProcedure
   {
                           ...
                           out GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item> aP4_CalendarEvents )
      {
         ...
         this.AV12CalendarEvents = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      {
         AV12CalendarEvents = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
