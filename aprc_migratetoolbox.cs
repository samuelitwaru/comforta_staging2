...
namespace GeneXus.Programs {
   public class aprc_migratetoolbox : GXProcedure
   {
      ...
      public aprc_migratetoolbox( IGxContext context )
      {
      ...
      public override void initialize( )
      {
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.aprc_migratetoolbox__datastore1(),
            new Object[][] {
            }
         );
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.aprc_migratetoolbox__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aprc_migratetoolbox__default(),
            new Object[][] {
                new Object[] {
   ...
   public class aprc_migratetoolbox__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class aprc_migratetoolbox__gam : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
...
public class aprc_migratetoolbox__default : DataStoreHelperBase, IDataStoreHelper
{
