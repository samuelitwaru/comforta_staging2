...
namespace GeneXus.Programs {
   public class wp_applicationdesign : GXDataArea
   {
      ...
      protected void E125C2( )
      {
         ...
         pr_default.close(2);
         AV61Udparg1 = new prc_getuserlocationid(context).executeUdp( );
         AV62Udparg2 = new prc_getuserorganisationid(context).executeUdp( );
         /* Using cursor H005C5 */
         pr_default.execute(3, new Object[] {AV61Udparg1, AV62Udparg2});
         ...
         AV62Udparg2 = new prc_getuserorganisationid(context).executeUdp( );
         /* Using cursor H005C6 */
         pr_default.execute(4, new Object[] {AV61Udparg1, AV62Udparg2});
         ...
         AV61Udparg1 = new prc_getuserlocationid(context).executeUdp( );
         /* Using cursor H005C7 */
         pr_default.execute(5, new Object[] {AV61Udparg1});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202541111254325", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_applicationdesign.js", "?202541111254326", false, true);
         context.AddJavascriptSource("UserControls/UC_AppToolBox1Render.js", "", false, true);
...
public class wp_applicationdesign__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       new ParDef("AV62Udparg2",GXType.UniqueIdentifier,36,0)
       };
       Object[] prmH005C6;
