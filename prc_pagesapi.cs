...
namespace GeneXus.Programs {
   public class prc_pagesapi : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtSDT_MobilePage> aP3_SDT_PageCollection )
      {
         ...
         this.AV5SDT_PageCollection = new GXBaseCollection<SdtSDT_MobilePage>( context, "SDT_MobilePage", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      {
         AV5SDT_PageCollection = new GXBaseCollection<SdtSDT_MobilePage>( context, "SDT_MobilePage", "Comforta_version20");
         /* GeneXus formulas. */
      }
