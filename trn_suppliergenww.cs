...
namespace GeneXus.Programs {
   public class trn_suppliergenww : GXDataArea
   {
      ...
      protected void RF492( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A11OrganisationId = H00492_A11OrganisationId[0];
               n11OrganisationId = H00492_n11OrganisationId[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253262311190", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_suppliergenww.js", "?20253262311192", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H00492_n11OrganisationId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_suppliergenww__default(),
            new Object[][] {
                new Object[] {
               H00492_A428SupplierGenWebsite, H00492_A501SupplierGenEmail, H00492_A354SupplierGenPhoneNumber, H00492_A353SupplierGenPhoneCode, H00492_A11OrganisationId, H00492_n11OrganisationId, H00492_A48SupplierGenContactPhone, H00492_A47SupplierGenContactName, H00492_A311SupplierGenAddressLine2, H00492_A310SupplierGenAddressLine1,
      ...
      private bool[] H00492_n11OrganisationId ;
   ...
   public class trn_suppliergenww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         switch ( cursor )
         {
               ...
               case 1 :
                     return conditional_H00493(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (short)dynConstraints[13] , (bool)dynConstraints[14] , (Guid)dynConstraints[15] );
         }
