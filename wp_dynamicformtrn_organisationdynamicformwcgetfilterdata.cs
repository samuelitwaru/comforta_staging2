...
namespace GeneXus.Programs {
   public class wp_dynamicformtrn_organisationdynamicformwcgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV34GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "WP_DynamicFormTrn_OrganisationDynamicFormWCGridState"), null, "", "");
         }
         else
         {
         ...
         {
            AV35GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV34GridState.gxTpr_Filtervalues.Item(AV48GXV1));
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_dynamicformtrn_organisationdynamicformwcgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00DZ2_A240WWPFormType, P00DZ2_A209WWPFormTitle, P00DZ2_A231WWPFormDate, P00DZ2_A207WWPFormVersionNumber, P00DZ2_A208WWPFormReferenceName, P00DZ2_A206WWPFormId, P00DZ2_A509OrganisationDynamicFormId, P00DZ2_A11OrganisationId
               }
               , new Object[] {
               P00DZ3_A240WWPFormType, P00DZ3_A207WWPFormVersionNumber, P00DZ3_A231WWPFormDate, P00DZ3_A208WWPFormReferenceName, P00DZ3_A209WWPFormTitle, P00DZ3_A206WWPFormId, P00DZ3_A509OrganisationDynamicFormId, P00DZ3_A11OrganisationId
               }
            }
         );
         /* GeneXus formulas. */
   ...
   public class wp_dynamicformtrn_organisationdynamicformwcgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A240WWPFormType )
      {
         ...
         scmdbuf = "SELECT T2.WWPFormType, T2.WWPFormTitle, T2.WWPFormDate, T1.WWPFormVersionNumber, T2.WWPFormReferenceName, T1.WWPFormId, T1.OrganisationDynamicFormId, T1.OrganisationId FROM (Trn_OrganisationDynamicForm T1 INNER JOIN WWP_Form T2 ON T2.WWPFormId = T1.WWPFormId AND T2.WWPFormVersionNumber = T1.WWPFormVersionNumber)";
