   ...
   public class wp_createlocationandreceptioniststep1 : GXWebComponent
   {
      ...
      protected void WB650( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_57_652( true) ;
         }
         else
         {
            wb_table1_57_652( false) ;
         }
         return  ;
      }

      protected void wb_table1_57_652e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void S132( )
      {
         ...
         {
            AV29LocationCountry_DPItem = ((SdtSDT_Country_SDT_CountryItem)AV42GXV1.Item(AV43GXV2));
            AV28Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void wb_table1_57_652( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUseractiondelete_Internalname, context.GetMessage( "<i class=\"fas fa-trash-can\"></i>", ""), "", "", lblUseractiondelete_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e19651_client"+"'", "", "TextBlock", 7, "", lblUseractiondelete_Visible, 1, 0, 1, "HLP_WP_CreateLocationAndReceptionistStep1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_57_652e( true) ;
         }
         else
         {
            wb_table1_57_652e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253273225270", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_createlocationandreceptioniststep1.js", "?20253273225271", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'WIZARDPREVIOUS'","""{"handler":"E14652","iparms":[{"av":"AV41OrganisationId","fld":"vORGANISATIONID"}]}""");
         setEventMetadata("'DOUSERACTIONDELETE'","""{"handler":"E19651","iparms":[]""");
         ...
         setEventMetadata("VLOCATIONZIPCODE.CONTROLVALUECHANGED","""{"handler":"E15652","iparms":[{"av":"AV18LocationZipCode","fld":"vLOCATIONZIPCODE"}]""");
         ...
         setEventMetadata("VLOCATIONPHONENUMBER.CONTROLVALUECHANGED","""{"handler":"E16652","iparms":[{"av":"AV34LocationPhoneNumber","fld":"vLOCATIONPHONENUMBER"}]""");
         ...
         setEventMetadata("VFILENAME.CONTROLVALUECHANGED","""{"handler":"E17652","iparms":[{"av":"AV36FileName","fld":"vFILENAME"}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV37UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Comforta_version20");
         AV38FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Comforta_version20");
         AV21LocationDescription = "";
         AV25LocationCountry_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         GX_FocusControl = "";
         ClassString = "";
         StyleString = "";
         TempTags = "";
         ...
         AV36FileName = "";
         GXt_char2 = "";
         AV42GXV1 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
         AV29LocationCountry_DPItem = new SdtSDT_Country_SDT_CountryItem(context);
         AV28Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV24ComboTitles = new GxSimpleCollection<string>();
         AV44GXV3 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV25LocationCountry_Data ;
      ...
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV28Combo_DataItem ;
