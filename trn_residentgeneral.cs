...
namespace GeneXus.Programs {
   public class trn_residentgeneral : GXWebComponent
   {
      ...
      protected void GXDLARESIDENTPACKAGEID5K1( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLARESIDENTPACKAGEID_data5K1( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXARESIDENTPACKAGEID_html5K1( )
      {
         Guid gxdynajaxvalue;
         GXDLARESIDENTPACKAGEID_data5K1( ) ;
         gxdynajaxindex = 1;
         ...
         {
            A527ResidentPackageId = StringUtil.StrToGuid( dynResidentPackageId.getValidValue(A527ResidentPackageId.ToString()));
            n527ResidentPackageId = false;
            AssignAttri(sPrefix, false, "A527ResidentPackageId", A527ResidentPackageId.ToString());
         }
      }

      protected void GXDLARESIDENTPACKAGEID_data5K1( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(H005K2_A527ResidentPackageId[0].ToString());
            gxdynajaxctrldescr.Add(H005K2_A531ResidentPackageName[0]);
      ...
      protected void clear_multi_value_controls( )
      {
         if ( context.isAjaxRequest( ) )
         {
            ...
            {
               dynResidentPackageId.addItem(H005K3_A527ResidentPackageId[0].ToString(), H005K3_A531ResidentPackageName[0], 0);
      ...
      protected void STRUP5K0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            A527ResidentPackageId = StringUtil.StrToGuid( cgiGet( dynResidentPackageId_Internalname));
            n527ResidentPackageId = false;
            AssignAttri(sPrefix, false, "A527ResidentPackageId", A527ResidentPackageId.ToString());
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532622505823", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_residentgeneral.js", "?202532622505824", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         {
            dynResidentPackageId.addItem(H005K5_A527ResidentPackageId[0].ToString(), H005K5_A531ResidentPackageName[0], 0);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"dynResidentPackageId"},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H005K3_A527ResidentPackageId = new Guid[] {Guid.Empty} ;
         H005K3_n527ResidentPackageId = new bool[] {false} ;
         H005K3_A531ResidentPackageName = new string[] {""} ;
         H005K4_A62ResidentId = new Guid[] {Guid.Empty} ;
         H005K4_A29LocationId = new Guid[] {Guid.Empty} ;
         H005K4_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H005K4_A96ResidentTypeId = new Guid[] {Guid.Empty} ;
         H005K4_n96ResidentTypeId = new bool[] {false} ;
         H005K4_A98MedicalIndicationId = new Guid[] {Guid.Empty} ;
         H005K4_n98MedicalIndicationId = new bool[] {false} ;
         H005K4_A71ResidentGUID = new string[] {""} ;
         H005K4_A66ResidentInitials = new string[] {""} ;
         H005K4_A528SG_LocationId = new Guid[] {Guid.Empty} ;
         H005K4_A529SG_OrganisationId = new Guid[] {Guid.Empty} ;
         H005K4_A527ResidentPackageId = new Guid[] {Guid.Empty} ;
         H005K4_n527ResidentPackageId = new bool[] {false} ;
         H005K4_A97ResidentTypeName = new string[] {""} ;
         H005K4_A313ResidentCity = new string[] {""} ;
         H005K4_A314ResidentZipCode = new string[] {""} ;
         H005K4_A316ResidentAddressLine2 = new string[] {""} ;
         H005K4_A315ResidentAddressLine1 = new string[] {""} ;
         H005K4_A63ResidentBsnNumber = new string[] {""} ;
         H005K4_A430ResidentHomePhone = new string[] {""} ;
         H005K4_A70ResidentPhone = new string[] {""} ;
         H005K4_A432ResidentHomePhoneNumber = new string[] {""} ;
         H005K4_A348ResidentPhoneNumber = new string[] {""} ;
         H005K4_A67ResidentEmail = new string[] {""} ;
         H005K4_A73ResidentBirthDate = new DateTime[] {DateTime.MinValue} ;
         H005K4_A68ResidentGender = new string[] {""} ;
         H005K4_A65ResidentLastName = new string[] {""} ;
         H005K4_A64ResidentGivenName = new string[] {""} ;
         H005K4_A72ResidentSalutation = new string[] {""} ;
         ...
         H005K5_A527ResidentPackageId = new Guid[] {Guid.Empty} ;
         H005K5_n527ResidentPackageId = new bool[] {false} ;
         H005K5_A531ResidentPackageName = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentgeneral__default(),
            new Object[][] {
                new Object[] {
               H005K2_A527ResidentPackageId, H005K2_A531ResidentPackageName
               }
               , new Object[] {
               H005K3_A527ResidentPackageId, H005K3_A531ResidentPackageName
               }
               , new Object[] {
               H005K4_A62ResidentId, H005K4_A29LocationId, H005K4_A11OrganisationId, H005K4_A96ResidentTypeId, H005K4_n96ResidentTypeId, H005K4_A98MedicalIndicationId, H005K4_n98MedicalIndicationId, H005K4_A71ResidentGUID, H005K4_A66ResidentInitials, H005K4_A528SG_LocationId,
               H005K4_A529SG_OrganisationId, H005K4_A527ResidentPackageId, H005K4_n527ResidentPackageId, H005K4_A97ResidentTypeName, H005K4_A313ResidentCity, H005K4_A314ResidentZipCode, H005K4_A316ResidentAddressLine2, H005K4_A315ResidentAddressLine1, H005K4_A63ResidentBsnNumber, H005K4_A430ResidentHomePhone,
               H005K4_A70ResidentPhone, H005K4_A432ResidentHomePhoneNumber, H005K4_A348ResidentPhoneNumber, H005K4_A67ResidentEmail, H005K4_A73ResidentBirthDate, H005K4_A68ResidentGender, H005K4_A65ResidentLastName, H005K4_A64ResidentGivenName, H005K4_A72ResidentSalutation
               }
               , new Object[] {
               H005K5_A527ResidentPackageId, H005K5_A531ResidentPackageName
               }
            }
         );
         AV29Pgmname = "Trn_ResidentGeneral";
      ...
      private Guid[] H005K3_A527ResidentPackageId ;
      private bool[] H005K3_n527ResidentPackageId ;
      private string[] H005K3_A531ResidentPackageName ;
      private Guid[] H005K4_A62ResidentId ;
      private Guid[] H005K4_A29LocationId ;
      private Guid[] H005K4_A11OrganisationId ;
      private Guid[] H005K4_A96ResidentTypeId ;
      private bool[] H005K4_n96ResidentTypeId ;
      private Guid[] H005K4_A98MedicalIndicationId ;
      private bool[] H005K4_n98MedicalIndicationId ;
      private string[] H005K4_A71ResidentGUID ;
      private string[] H005K4_A66ResidentInitials ;
      private Guid[] H005K4_A528SG_LocationId ;
      private Guid[] H005K4_A529SG_OrganisationId ;
      private Guid[] H005K4_A527ResidentPackageId ;
      private bool[] H005K4_n527ResidentPackageId ;
      private string[] H005K4_A97ResidentTypeName ;
      private string[] H005K4_A313ResidentCity ;
      private string[] H005K4_A314ResidentZipCode ;
      private string[] H005K4_A316ResidentAddressLine2 ;
      private string[] H005K4_A315ResidentAddressLine1 ;
      private string[] H005K4_A63ResidentBsnNumber ;
      private string[] H005K4_A430ResidentHomePhone ;
      private string[] H005K4_A70ResidentPhone ;
      private string[] H005K4_A432ResidentHomePhoneNumber ;
      private string[] H005K4_A348ResidentPhoneNumber ;
      private string[] H005K4_A67ResidentEmail ;
      private DateTime[] H005K4_A73ResidentBirthDate ;
      private string[] H005K4_A68ResidentGender ;
      private string[] H005K4_A65ResidentLastName ;
      private string[] H005K4_A64ResidentGivenName ;
      private string[] H005K4_A72ResidentSalutation ;
      ...
      private Guid[] H005K5_A527ResidentPackageId ;
      private bool[] H005K5_n527ResidentPackageId ;
      private string[] H005K5_A531ResidentPackageName ;
   }
   ...
   public class trn_residentgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005K2", "SELECT ResidentPackageId, ResidentPackageName FROM Trn_ResidentPackage ORDER BY ResidentPackageName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005K2,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H005K3", "SELECT ResidentPackageId, ResidentPackageName FROM Trn_ResidentPackage ORDER BY ResidentPackageName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005K3,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H005K4", "SELECT T1.ResidentId, T1.LocationId, T1.OrganisationId, T1.ResidentTypeId, T1.MedicalIndicationId, T1.ResidentGUID, T1.ResidentInitials, T3.SG_LocationId, T3.SG_OrganisationId, T1.ResidentPackageId, T2.ResidentTypeName, T1.ResidentCity, T1.ResidentZipCode, T1.ResidentAddressLine2, T1.ResidentAddressLine1, T1.ResidentBsnNumber, T1.ResidentHomePhone, T1.ResidentPhone, T1.ResidentHomePhoneNumber, T1.ResidentPhoneNumber, T1.ResidentEmail, T1.ResidentBirthDate, T1.ResidentGender, T1.ResidentLastName, T1.ResidentGivenName, T1.ResidentSalutation FROM ((Trn_Resident T1 LEFT JOIN Trn_ResidentType T2 ON T2.ResidentTypeId = T1.ResidentTypeId) LEFT JOIN Trn_ResidentPackage T3 ON T3.ResidentPackageId = T1.ResidentPackageId) WHERE T1.ResidentId = :ResidentId and T1.LocationId = :LocationId and T1.OrganisationId = :OrganisationId ORDER BY T1.ResidentId, T1.LocationId, T1.OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005K4,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H005K5", "SELECT ResidentPackageId, ResidentPackageName FROM Trn_ResidentPackage ORDER BY ResidentPackageName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005K5,0, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
