...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_InfoContent.InfoContentItem" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_InfoContent.InfoContentItem", Namespace="Comforta_version20")]
