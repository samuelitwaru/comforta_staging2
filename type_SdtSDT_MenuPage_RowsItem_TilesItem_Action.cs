...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_MenuPage.RowsItem.TilesItem.Action" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_MenuPage.RowsItem.TilesItem.Action", Namespace="Comforta_version20")]
