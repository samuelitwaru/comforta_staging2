...
namespace GeneXus.Programs {
   public class prc_adddiscussiontranslationtosdt : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A200WWPDiscussionMessageId = P00ED2_A200WWPDiscussionMessageId[0];
            A204WWPDiscussionMessageMessage = P00ED2_A204WWPDiscussionMessageMessage[0];
      ...
      public override void initialize( )
      {
         ...
         P00ED2_A200WWPDiscussionMessageId = new long[1] ;
         P00ED2_A204WWPDiscussionMessageMessage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_adddiscussiontranslationtosdt__default(),
            new Object[][] {
                new Object[] {
               P00ED2_A200WWPDiscussionMessageId, P00ED2_A204WWPDiscussionMessageMessage
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P00ED2_A200WWPDiscussionMessageId ;
      private string[] P00ED2_A204WWPDiscussionMessageMessage ;
   ...
   public class prc_adddiscussiontranslationtosdt__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00ED2", "SELECT WWPDiscussionMessageId, WWPDiscussionMessageMessage FROM WWP_DiscussionMessage WHERE WWPDiscussionMessageId = :AV9WWPDiscussionMessageId ORDER BY WWPDiscussionMessageId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00ED2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
