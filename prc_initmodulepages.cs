...
namespace GeneXus.Programs {
   public class prc_initmodulepages : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A523AppVersionId = P00E82_A523AppVersionId[0];
            /* Using cursor P00E83 */
            pr_default.execute(1, new Object[] {A523AppVersionId});
            while ( (pr_default.getStatus(1) != 101) )
            {
               A525PageType = P00E83_A525PageType[0];
               A516PageId = P00E83_A516PageId[0];
      ...
      public override void initialize( )
      {
         ...
         P00E82_A523AppVersionId = new Guid[] {Guid.Empty} ;
         A523AppVersionId = Guid.Empty;
         P00E83_A523AppVersionId = new Guid[] {Guid.Empty} ;
         P00E83_A525PageType = new string[] {""} ;
         P00E83_A516PageId = new Guid[] {Guid.Empty} ;
         A525PageType = "";
         A516PageId = Guid.Empty;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_initmodulepages__default(),
            new Object[][] {
                new Object[] {
               P00E82_A523AppVersionId
               }
               , new Object[] {
               P00E83_A523AppVersionId, P00E83_A525PageType, P00E83_A516PageId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00E82_A523AppVersionId ;
      private Guid[] P00E83_A523AppVersionId ;
      private string[] P00E83_A525PageType ;
      private Guid[] P00E83_A516PageId ;
   ...
   public class prc_initmodulepages__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00E82", "SELECT AppVersionId FROM Trn_AppVersion WHERE AppVersionId = :AV8AppVersionId ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00E82,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("P00E83", "SELECT AppVersionId, PageType, PageId FROM Trn_AppVersionPage WHERE AppVersionId = :AppVersionId ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00E83,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
