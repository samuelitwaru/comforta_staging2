      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            while ( (pr_default.getStatus(1) != 101) )
            {
               ...
               new prc_logtofile(context ).execute(  A517PageName+" : "+AV10PageItem.ToJSonString(false, true)) ;
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_loadappversionsdt__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00CA3_A523AppVersionId, P00CA3_A516PageId, P00CA3_A517PageName, P00CA3_A525PageType, P00CA3_A40000PageThumbnail_GXI, P00CA3_n40000PageThumbnail_GXI, P00CA3_A518PageStructure
               }
            }
         );
         /* GeneXus formulas. */
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00CA3", "SELECT AppVersionId, PageId, PageName, PageType, PageThumbnail_GXI, PageStructure FROM Trn_AppVersionPage WHERE AppVersionId = :AppVersionId ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00CA3,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
