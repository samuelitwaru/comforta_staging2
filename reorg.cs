...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeTrn_AppVersionPage( )
      {
         ...
         cmdBuffer=" ALTER TABLE Trn_AppVersionPage ADD PageThumbnail BYTEA , ADD PageThumbnail_GXI VARCHAR(2048)  "
         ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("Trn_AppVersionPage",sSchemaVar,"PageThumbnail") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"PageThumbnail", "Trn_AppVersionPage"}) ) ;
            return false ;
         }
         if ( ColumnExist("Trn_AppVersionPage",sSchemaVar,"PageThumbnail_GXI") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"PageThumbnail_GXI", "Trn_AppVersionPage"}) ) ;
            return false ;
         }
         return true ;
      }
