...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Trn_Theme" , Namespace = "Comforta_version20" )]
   [Serializable]
   public class SdtTrn_Theme : GxSilentTrnSdt
   {
      ...
      public GXBCLevelCollection<SdtTrn_Theme_CtaColor> gxTpr_Ctacolor_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtTrn_Theme_Ctacolor == null )
            {
               gxTv_SdtTrn_Theme_Ctacolor = new GXBCLevelCollection<SdtTrn_Theme_CtaColor>( context, "Trn_Theme.CtaColor", "Comforta_version20");
            }
      ...
      public GXBCLevelCollection<SdtTrn_Theme_Icon> gxTpr_Icon_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtTrn_Theme_Icon == null )
            {
               gxTv_SdtTrn_Theme_Icon = new GXBCLevelCollection<SdtTrn_Theme_Icon>( context, "Trn_Theme.Icon", "Comforta_version20");
            }
      ...
      public GXBCLevelCollection<SdtTrn_Theme_Color> gxTpr_Color_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtTrn_Theme_Color == null )
            {
               gxTv_SdtTrn_Theme_Color = new GXBCLevelCollection<SdtTrn_Theme_Color>( context, "Trn_Theme.Color", "Comforta_version20");
            }
   ...
   [DataContract(Name = @"Trn_Theme", Namespace = "Comforta_version20")]
