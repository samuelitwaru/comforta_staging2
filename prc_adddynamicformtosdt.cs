...
namespace GeneXus.Programs {
   public class prc_adddynamicformtosdt : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtSDT_DynamicFormTranslation> aP2_SDT_DynamicFormTranslationCollection )
      {
         ...
         this.AV11SDT_DynamicFormTranslationCollection = new GXBaseCollection<SdtSDT_DynamicFormTranslation>( context, "SDT_DynamicFormTranslation", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A206WWPFormId = P00EF2_A206WWPFormId[0];
            A207WWPFormVersionNumber = P00EF2_A207WWPFormVersionNumber[0];
            A209WWPFormTitle = P00EF2_A209WWPFormTitle[0];
            ...
            {
               A210WWPFormElementId = P00EF3_A210WWPFormElementId[0];
               A229WWPFormElementTitle = P00EF3_A229WWPFormElementTitle[0];
               AV10SDT_DynamicFormTranslation = new SdtSDT_DynamicFormTranslation(context);
               AV10SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformid = A206WWPFormId;
               AV10SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformversionnumber = A207WWPFormVersionNumber;
      ...
      {
         AV11SDT_DynamicFormTranslationCollection = new GXBaseCollection<SdtSDT_DynamicFormTranslation>( context, "SDT_DynamicFormTranslation", "Comforta_version20");
         P00EF2_A206WWPFormId = new short[1] ;
         P00EF2_A207WWPFormVersionNumber = new short[1] ;
         P00EF2_A209WWPFormTitle = new string[] {""} ;
         A209WWPFormTitle = "";
         AV10SDT_DynamicFormTranslation = new SdtSDT_DynamicFormTranslation(context);
         P00EF3_A206WWPFormId = new short[1] ;
         P00EF3_A207WWPFormVersionNumber = new short[1] ;
         P00EF3_A210WWPFormElementId = new short[1] ;
         P00EF3_A229WWPFormElementTitle = new string[] {""} ;
         A229WWPFormElementTitle = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_adddynamicformtosdt__default(),
            new Object[][] {
                new Object[] {
               P00EF2_A206WWPFormId, P00EF2_A207WWPFormVersionNumber, P00EF2_A209WWPFormTitle
               }
               , new Object[] {
               P00EF3_A206WWPFormId, P00EF3_A207WWPFormVersionNumber, P00EF3_A210WWPFormElementId, P00EF3_A229WWPFormElementTitle
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] P00EF2_A206WWPFormId ;
      private short[] P00EF2_A207WWPFormVersionNumber ;
      private string[] P00EF2_A209WWPFormTitle ;
      private SdtSDT_DynamicFormTranslation AV10SDT_DynamicFormTranslation ;
      private short[] P00EF3_A206WWPFormId ;
      private short[] P00EF3_A207WWPFormVersionNumber ;
      private short[] P00EF3_A210WWPFormElementId ;
      private string[] P00EF3_A229WWPFormElementTitle ;
   ...
   public class prc_adddynamicformtosdt__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00EF2", "SELECT WWPFormId, WWPFormVersionNumber, WWPFormTitle FROM WWP_Form WHERE WWPFormId = :AV8WWPFormId and WWPFormVersionNumber = :AV9WWPFormVersionNumber ORDER BY WWPFormId, WWPFormVersionNumber ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00EF2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("P00EF3", "SELECT WWPFormId, WWPFormVersionNumber, WWPFormElementId, WWPFormElementTitle FROM WWP_FormElement WHERE WWPFormId = :WWPFormId and WWPFormVersionNumber = :WWPFormVersionNumber ORDER BY WWPFormId, WWPFormVersionNumber ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00EF3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
