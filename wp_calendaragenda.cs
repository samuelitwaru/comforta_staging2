...
namespace GeneXus.Programs {
   public class wp_calendaragenda : GXDataArea
   {
      ...
      protected void S152( )
      {
         ...
         if ( ( DateTimeUtil.ResetTime ( AV23DotsFromDate ) < DateTimeUtil.ResetTime ( AV31LoadedDotsFromDate ) ) || ( DateTimeUtil.ResetTime ( AV24DotsToDate ) > DateTimeUtil.ResetTime ( AV32LoadedDotsToDate ) ) )
         {
            ...
            if ( ( DateTimeUtil.ResetTime ( AV23DotsFromDate ) < DateTimeUtil.ResetTime ( AV33LoadedFromDate ) ) || ( DateTimeUtil.ResetTime ( AV24DotsToDate ) > DateTimeUtil.ResetTime ( AV34LoadedToDate ) ) )
            {
               ...
               AV26EventsAux = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
            }
            else
            {
               GXt_SdtWWPDateRangePickerOptions5 = AV37WWPDateRangePickerOptions;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254111575194", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_calendaragenda.js", "?20254111575194", false, true);
         context.AddJavascriptSource("DVelop/Calendar/index.global.min.js", "", false, true);
         context.AddJavascriptSource("DVelop/Calendar/WWPCalendarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/daterangepicker/locales.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/daterangepicker/wwp-daterangepicker.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VDATETYPEFILTER.CLICK","""{"handler":"E114U1","iparms":[{"av":"cmbavDatetypefilter"},{"av":"AV20DateTypeFilter","fld":"vDATETYPEFILTER","pic":"ZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         AV25Events = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
         ...
         GXt_objcol_SdtWWP_Calendar_Events_Item3 = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
