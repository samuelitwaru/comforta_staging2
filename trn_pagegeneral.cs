...
namespace GeneXus.Programs {
   public class trn_pagegeneral : GXWebComponent
   {
                           ...
                           Guid aP2_LocationId )
      {
         ...
         this.A397Trn_PageName = aP1_Trn_PageName;
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  A397Trn_PageName = GetPar( "Trn_PageName");
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)A392Trn_PageId,(string)A397Trn_PageName,(Guid)A29LocationId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_pagegeneral.aspx"+UrlEncode(A392Trn_PageId.ToString()) + "," + UrlEncode(StringUtil.RTrim(A397Trn_PageName)) + "," + UrlEncode(A29LocationId.ToString());
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA397Trn_PageName", wcpOA397Trn_PageName);
      ...
      protected void RF792( )
      {
         ...
         {
            /* Using cursor H00792 */
            pr_default.execute(0, new Object[] {A392Trn_PageId, A29LocationId, A397Trn_PageName});
      ...
      protected void STRUP790( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOA397Trn_PageName = cgiGet( sPrefix+"wcpOA397Trn_PageName");
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri(sPrefix, false, "A392Trn_PageId", A392Trn_PageId.ToString());
         A397Trn_PageName = (string)getParm(obj,1);
         AssignAttri(sPrefix, false, "A397Trn_PageName", A397Trn_PageName);
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA397Trn_PageName = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "A392Trn_PageId", A392Trn_PageId.ToString());
            A397Trn_PageName = (string)getParm(obj,3);
            AssignAttri(sPrefix, false, "A397Trn_PageName", A397Trn_PageName);
         ...
         wcpOA397Trn_PageName = cgiGet( sPrefix+"wcpOA397Trn_PageName");
         wcpOA29LocationId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA29LocationId"));
         if ( ! GetJustCreated( ) && ( ( A392Trn_PageId != wcpOA392Trn_PageId ) || ( StringUtil.StrCmp(A397Trn_PageName, wcpOA397Trn_PageName) != 0 ) || ( A29LocationId != wcpOA29LocationId ) ) )
         {
            setjustcreated();
         }
         wcpOA392Trn_PageId = A392Trn_PageId;
         wcpOA397Trn_PageName = A397Trn_PageName;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlA397Trn_PageName = cgiGet( sPrefix+"A397Trn_PageName_CTRL");
         if ( StringUtil.Len( sCtrlA397Trn_PageName) > 0 )
         {
            A397Trn_PageName = cgiGet( sCtrlA397Trn_PageName);
            AssignAttri(sPrefix, false, "A397Trn_PageName", A397Trn_PageName);
         }
         else
         {
            A397Trn_PageName = cgiGet( sPrefix+"A397Trn_PageName_PARM");
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"A397Trn_PageName_PARM", A397Trn_PageName);
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA397Trn_PageName)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A397Trn_PageName_CTRL", StringUtil.RTrim( sCtrlA397Trn_PageName));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532712503747", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_pagegeneral.js", "?202532712503747", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A392Trn_PageId","fld":"TRN_PAGEID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A397Trn_PageName","fld":"TRN_PAGENAME"},{"av":"A423PageIsPublished","fld":"PAGEISPUBLISHED"},{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         sCtrlA392Trn_PageId = "";
         sCtrlA397Trn_PageName = "";
         sCtrlA29LocationId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_pagegeneral__default(),
            new Object[][] {
                new Object[] {
               H00792_A392Trn_PageId, H00792_A29LocationId, H00792_A397Trn_PageName, H00792_A11OrganisationId, H00792_A58ProductServiceId, H00792_n58ProductServiceId, H00792_A13OrganisationName, H00792_A59ProductServiceName, H00792_A424PageChildren, H00792_n424PageChildren,
               H00792_A429PageIsContentPage, H00792_n429PageIsContentPage, H00792_A423PageIsPublished, H00792_n423PageIsPublished, H00792_A422PageGJSJson, H00792_n422PageGJSJson, H00792_A421PageGJSHtml, H00792_n421PageGJSHtml, H00792_A420PageJsonContent, H00792_n420PageJsonContent,
               H00792_A31LocationName
               }
            }
         );
         AV15Pgmname = "Trn_PageGeneral";
      ...
      private string sCtrlA397Trn_PageName ;
      ...
      private string wcpOA397Trn_PageName ;
