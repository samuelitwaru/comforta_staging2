...
namespace GeneXus.Programs {
   public class prc_addproductserviceattributestosdt : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A58ProductServiceId = P00DV2_A58ProductServiceId[0];
            A59ProductServiceName = P00DV2_A59ProductServiceName[0];
            A266ProductServiceTileName = P00DV2_A266ProductServiceTileName[0];
            A60ProductServiceDescription = P00DV2_A60ProductServiceDescription[0];
            A29LocationId = P00DV2_A29LocationId[0];
            A11OrganisationId = P00DV2_A11OrganisationId[0];
      ...
      {
         AV9SDT_TrnAttributes = new SdtSDT_TrnAttributes(context);
         P00DV2_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         P00DV2_A59ProductServiceName = new string[] {""} ;
         P00DV2_A266ProductServiceTileName = new string[] {""} ;
         P00DV2_A60ProductServiceDescription = new string[] {""} ;
         P00DV2_A29LocationId = new Guid[] {Guid.Empty} ;
         P00DV2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_addproductserviceattributestosdt__default(),
            new Object[][] {
                new Object[] {
               P00DV2_A58ProductServiceId, P00DV2_A59ProductServiceName, P00DV2_A266ProductServiceTileName, P00DV2_A60ProductServiceDescription, P00DV2_A29LocationId, P00DV2_A11OrganisationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00DV2_A58ProductServiceId ;
      private string[] P00DV2_A59ProductServiceName ;
      private string[] P00DV2_A266ProductServiceTileName ;
      private string[] P00DV2_A60ProductServiceDescription ;
      private Guid[] P00DV2_A29LocationId ;
      private Guid[] P00DV2_A11OrganisationId ;
