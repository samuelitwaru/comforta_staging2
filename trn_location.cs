...
namespace GeneXus.Programs {
   public class trn_location : GXDataArea
   {
      ...
      public void ScanStart04103( )
      {
         ...
         {
            RcdFound103 = 1;
            A29LocationId = T000432_A29LocationId[0];
            n29LocationId = T000432_n29LocationId[0];
            AssignAttri("", false, "A29LocationId", A29LocationId.ToString());
            A11OrganisationId = T000432_A11OrganisationId[0];
            n11OrganisationId = T000432_n11OrganisationId[0];
            AssignAttri("", false, "A11OrganisationId", A11OrganisationId.ToString());
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254112113892", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_location.js", "?20254112113895", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
      ...
      public void Valid_Organisationid( )
      {
         ...
         pr_default.execute(31, new Object[] {n11OrganisationId, A11OrganisationId});
      ...
      public override void initialize( )
      {
         ...
         T000431_A89ReceptionistId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_location__default(),
            new Object[][] {
               ...
               , new Object[] {
               T000431_A89ReceptionistId, T000431_A11OrganisationId, T000431_A29LocationId
               }
               , new Object[] {
               T000432_A29LocationId, T000432_A11OrganisationId
               }
               , new Object[] {
               T000433_A11OrganisationId
               }
            }
         );
         Z573LocationHasOwnBrand = false;
      ...
      private Guid[] T000431_A89ReceptionistId ;
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
          ...
          ,new CursorDef("T000431", "SELECT ReceptionistId, OrganisationId, LocationId FROM Trn_Receptionist WHERE LocationId = :LocationId AND OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000431,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T000432", "SELECT LocationId, OrganisationId FROM Trn_Location ORDER BY LocationId, OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000432,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000433", "SELECT OrganisationId FROM Trn_Organisation WHERE OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000433,1, GxCacheFrequency.OFF ,true,false )
       };
    }
 }
