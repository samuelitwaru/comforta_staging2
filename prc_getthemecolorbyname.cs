...
namespace GeneXus.Programs {
   public class prc_getthemecolorbyname : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            if ( AV12GXLvl3 == 0 )
            {
               ...
               {
                  A539CtaColorName = P00DP4_A539CtaColorName[0];
                  A540CtaColorCode = P00DP4_A540CtaColorCode[0];
                  A538CtaColorId = P00DP4_A538CtaColorId[0];
      ...
      public override void initialize( )
      {
         ...
         P00DP4_A273Trn_ThemeId = new Guid[] {Guid.Empty} ;
         P00DP4_A539CtaColorName = new string[] {""} ;
         P00DP4_A540CtaColorCode = new string[] {""} ;
         P00DP4_A538CtaColorId = new Guid[] {Guid.Empty} ;
         A539CtaColorName = "";
         A540CtaColorCode = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getthemecolorbyname__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00DP4_A273Trn_ThemeId, P00DP4_A539CtaColorName, P00DP4_A540CtaColorCode, P00DP4_A538CtaColorId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00DP4_A273Trn_ThemeId ;
      private string[] P00DP4_A539CtaColorName ;
      private string[] P00DP4_A540CtaColorCode ;
      private Guid[] P00DP4_A538CtaColorId ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00DP4", "SELECT Trn_ThemeId, CtaColorName, CtaColorCode, CtaColorId FROM Trn_ThemeCtaColor WHERE Trn_ThemeId = :Trn_ThemeId and CtaColorName = ( :AV10ColorName) ORDER BY Trn_ThemeId, CtaColorName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00DP4,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
