...
namespace GeneXus.Programs {
   public class prc_migratetoolbox : GXProcedure
   {
      public prc_migratetoolbox( )
      {
      ...
      public prc_migratetoolbox( IGxContext context )
      {
      ...
      protected void S111( )
      {
         ...
         {
            context.CommitDataStores("prc_migratetoolbox",pr_default);
         }
         else
         {
            AV31GXV2 = 1;
      ...
      public override void initialize( )
      {
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.prc_migratetoolbox__datastore1(),
            new Object[][] {
            }
         );
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.prc_migratetoolbox__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_migratetoolbox__default(),
            new Object[][] {
                new Object[] {
   ...
   public class prc_migratetoolbox__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class prc_migratetoolbox__gam : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
...
public class prc_migratetoolbox__default : DataStoreHelperBase, IDataStoreHelper
{
