...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "UForm" , Namespace = "Comforta_version20" )]
   [Serializable]
   public class SdtUForm : GxSilentTrnSdt
   {
      ...
      public GXBCLevelCollection<SdtUForm_Element> gxTpr_Element_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtUForm_Element == null )
            {
               gxTv_SdtUForm_Element = new GXBCLevelCollection<SdtUForm_Element>( context, "UForm.Element", "Comforta_version20");
            }
   ...
   [DataContract(Name = @"UForm", Namespace = "Comforta_version20")]
