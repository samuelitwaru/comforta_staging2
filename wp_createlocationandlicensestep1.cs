   ...
   public class wp_createlocationandlicensestep1 : GXWebComponent
   {
      ...
      protected void WBAY0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_57_AY2( true) ;
         }
         else
         {
            wb_table1_57_AY2( false) ;
         }
         return  ;
      }

      protected void wb_table1_57_AY2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void wb_table1_57_AY2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_57_AY2e( true) ;
         }
         else
         {
            wb_table1_57_AY2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254111423448", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_createlocationandlicensestep1.js", "?20254111423449", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV68GXV1 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
         AV65LocationCountry_DPItem = new SdtSDT_Country_SDT_CountryItem(context);
         AV6Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV8ComboTitles = new GxSimpleCollection<string>();
         AV70GXV3 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
