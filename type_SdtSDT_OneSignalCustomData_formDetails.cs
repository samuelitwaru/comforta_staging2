...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_OneSignalCustomData.formDetails" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_OneSignalCustomData.formDetails", Namespace="Comforta_version20")]
