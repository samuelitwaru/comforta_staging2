...
namespace GeneXus.Programs {
   public class prc_getuserdashboarditems : GXProcedure
   {
      ...
      {
         this.AV10FilteredDashboardItems = new GXBaseCollection<SdtUHomeModulesSDT_UHomeModulesSDTItem>( context, "UHomeModulesSDTItem", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      {
         AV10FilteredDashboardItems = new GXBaseCollection<SdtUHomeModulesSDT_UHomeModulesSDTItem>( context, "UHomeModulesSDTItem", "Comforta_version20");
         ...
         AV12UserRoleName = "";
         AV9DashboardItems = new GXBaseCollection<SdtUHomeModulesSDT_UHomeModulesSDTItem>( context, "UHomeModulesSDTItem", "Comforta_version20");
         GXt_objcol_SdtUHomeModulesSDT_UHomeModulesSDTItem2 = new GXBaseCollection<SdtUHomeModulesSDT_UHomeModulesSDTItem>( context, "UHomeModulesSDTItem", "Comforta_version20");
