...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="WP_CreateLocationAndLicenseData.Step2" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"WP_CreateLocationAndLicenseData.Step2", Namespace="Comforta_version20")]
