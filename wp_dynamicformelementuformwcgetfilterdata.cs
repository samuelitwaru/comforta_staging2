...
namespace GeneXus.Programs {
   public class wp_dynamicformelementuformwcgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV34GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "WP_DynamicFormElementUFormWCGridState"), null, "", "");
         }
         else
         {
         ...
         {
            AV35GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV34GridState.gxTpr_Filtervalues.Item(AV49GXV1));
