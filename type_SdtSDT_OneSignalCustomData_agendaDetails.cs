...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_OneSignalCustomData.agendaDetails" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_OneSignalCustomData.agendaDetails", Namespace="Comforta_version20")]
