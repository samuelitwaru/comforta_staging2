...
namespace GeneXus.Programs {
   public class trn_suppliergenloaddvcombo : GXProcedure
   {
      ...
      protected void S131( )
      {
         ...
         if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
         {
            ...
            while ( (pr_default.getStatus(3) != 101) )
            {
               ...
               A353SupplierGenPhoneCode = P00685_A353SupplierGenPhoneCode[0];
      ...
      public override void initialize( )
      {
         ...
         P00685_A353SupplierGenPhoneCode = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_suppliergenloaddvcombo__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00685_A42SupplierGenId, P00685_A353SupplierGenPhoneCode
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00685_A353SupplierGenPhoneCode ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00685", "SELECT SupplierGenId, SupplierGenPhoneCode FROM Trn_SupplierGen WHERE SupplierGenId = :AV20SupplierGenId ORDER BY SupplierGenId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00685,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
