...
namespace GeneXus.Programs {
   public class wp_createlocationandreceptionist : GXDataArea
   {
      ...
      protected void E115Y2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV13WizardSteps = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Comforta_version20");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253262311123", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createlocationandreceptionist.js", "?20253262311123", false, true);
