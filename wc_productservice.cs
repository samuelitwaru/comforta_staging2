...
namespace GeneXus.Programs {
   public class wc_productservice : GXDataArea
   {
      ...
      protected void S122( )
      {
         ...
         {
            A11OrganisationId = H00A02_A11OrganisationId[0];
            n11OrganisationId = H00A02_n11OrganisationId[0];
      ...
      protected void S112( )
      {
         ...
         {
            A49SupplierAgbId = H00A03_A49SupplierAgbId[0];
            A51SupplierAgbName = H00A03_A51SupplierAgbName[0];
            AV31Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S202( )
      {
         ...
         else if ( ! AV40noFilterGen && ( StringUtil.StrCmp(AV13ProductServiceGroup, "Supplier") == 0 ) )
         {
            ...
            {
               A42SupplierGenId = H00A06_A42SupplierGenId[0];
               A11OrganisationId = H00A06_A11OrganisationId[0];
               n11OrganisationId = H00A06_n11OrganisationId[0];
               A44SupplierGenCompanyName = H00A06_A44SupplierGenCompanyName[0];
               AV31Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
               AV31Combo_DataItem.gxTpr_Id = StringUtil.Trim( A42SupplierGenId.ToString());
               AV31Combo_DataItem.gxTpr_Title = A44SupplierGenCompanyName;
               AV43SupplierGenId_Data.Add(AV31Combo_DataItem, 0);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253262372133", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wc_productservice.js", "?20253262372133", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H00A02_n11OrganisationId = new bool[] {false} ;
         H00A02_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H00A02_A44SupplierGenCompanyName = new string[] {""} ;
         A49SupplierAgbId = Guid.Empty;
         H00A03_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         H00A03_A51SupplierAgbName = new string[] {""} ;
         A51SupplierAgbName = "";
         ...
         H00A06_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H00A06_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00A06_n11OrganisationId = new bool[] {false} ;
         H00A06_A44SupplierGenCompanyName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wc_productservice__default(),
            new Object[][] {
                new Object[] {
               H00A02_A11OrganisationId, H00A02_n11OrganisationId, H00A02_A42SupplierGenId, H00A02_A44SupplierGenCompanyName
               }
               , new Object[] {
               H00A03_A49SupplierAgbId, H00A03_A51SupplierAgbName
               }
               , new Object[] {
               ...
               , new Object[] {
               H00A06_A42SupplierGenId, H00A06_A11OrganisationId, H00A06_n11OrganisationId, H00A06_A44SupplierGenCompanyName
               }
               , new Object[] {
               H00A07_A42SupplierGenId, H00A07_A44SupplierGenCompanyName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] H00A02_n11OrganisationId ;
      private Guid[] H00A02_A42SupplierGenId ;
      private string[] H00A02_A44SupplierGenCompanyName ;
      private Guid[] H00A03_A49SupplierAgbId ;
      private string[] H00A03_A51SupplierAgbName ;
      ...
      private Guid[] H00A06_A42SupplierGenId ;
      private Guid[] H00A06_A11OrganisationId ;
      private bool[] H00A06_n11OrganisationId ;
      private string[] H00A06_A44SupplierGenCompanyName ;
   ...
   public class wc_productservice__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_H00A03(context, (Guid)dynConstraints[0] , (GxSimpleCollection<Guid>)dynConstraints[1] );
               case 3 :
                     return conditional_H00A05(context, (Guid)dynConstraints[0] , (GxSimpleCollection<Guid>)dynConstraints[1] );
               case 4 :
                     return conditional_H00A06(context, (Guid)dynConstraints[0] , (GxSimpleCollection<Guid>)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
               case 5 :
                     return conditional_H00A07(context, (Guid)dynConstraints[0] , (GxSimpleCollection<Guid>)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00A02", "SELECT OrganisationId, SupplierGenId, SupplierGenCompanyName FROM Trn_SupplierGen WHERE OrganisationId = :AV47OrganisationId ORDER BY SupplierGenCompanyName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A02,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00A03", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A03,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00A04", "SELECT SupplierAgbId, SupplierAgbName FROM Trn_SupplierAGB ORDER BY SupplierAgbName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A04,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00A05", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A05,100, GxCacheFrequency.OFF ,false,false )
             ...
             ,new CursorDef("H00A07", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A07,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
