...
namespace GeneXus.Programs {
   public class trn_productservice : GXDataArea
   {
      ...
      protected void E11082( )
      {
         ...
         {
            AV68GXV1 = 1;
            AssignAttri("", false, "AV68GXV1", StringUtil.LTrimStr( (decimal)(AV68GXV1), 8, 0));
      ...
      protected void standaloneNotModal( )
      {
         ...
         AV67Pgmname = "Trn_ProductService";
         AssignAttri("", false, "AV67Pgmname", AV67Pgmname);
         Gx_BScreen = 0;
      ...
      protected void gxLoad_50( Guid A42SupplierGenId )
      {
         /* Using cursor T00089 */
      ...
      protected void gxLoad_51( Guid A49SupplierAgbId )
      {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532622553464", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_productservice.js", "?202532622553468", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
