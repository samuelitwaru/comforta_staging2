...
namespace GeneXus.Programs {
   public class trn_productservice : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtProductServiceTileName_Internalname, StringUtil.RTrim( A266ProductServiceTileName), StringUtil.RTrim( context.localUtil.Format( A266ProductServiceTileName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductServiceTileName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProductServiceTileName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_ProductService.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* ComboBox */
         GxWebStd.gx_combobox_ctrl1( context, dynProductServiceGroup, dynProductServiceGroup_Internalname, StringUtil.RTrim( A338ProductServiceGroup), 1, dynProductServiceGroup_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynProductServiceGroup.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,51);\"", "", true, 0, "HLP_Trn_ProductService.htm");
         dynProductServiceGroup.CurrentValue = StringUtil.RTrim( A338ProductServiceGroup);
      ...
      protected void E11082( )
      {
         ...
         {
            AV69GXV1 = 1;
            AssignAttri("", false, "AV69GXV1", StringUtil.LTrimStr( (decimal)(AV69GXV1), 8, 0));
      ...
      protected void E16082( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            AV64WWPNotificationMetadataSDT = new GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationMetadata(context);
            ...
            AV62NotificationDescription = StringUtil.Format( context.GetMessage( "%1 added by %2 %3", ""), A59ProductServiceName, AV61RoleName, GXt_char3, "", "", "", "", "", "");
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            AV62NotificationDescription = StringUtil.Format( context.GetMessage( "%1 updated by %2 %3", ""), A59ProductServiceName, AV61RoleName, GXt_char4, "", "", "", "", "", "");
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_productserviceview.aspx"+UrlEncode(A58ProductServiceId.ToString()) + "," + UrlEncode(A29LocationId.ToString()) + "," + UrlEncode(A11OrganisationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(""));
            AV55NotificationLink = formatLink("trn_productserviceview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         ...
         if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.wwp_getloggeduserid(context ).execute( out  GXt_char3) ;
            new GeneXus.Programs.wwpbaseobjects.wwp_getuserfullname(context ).execute(  GXt_char3, out  GXt_char4) ;
            AV62NotificationDescription = StringUtil.Format( context.GetMessage( "%1 deleted by %2 %3", ""), A59ProductServiceName, AV61RoleName, GXt_char4, "", "", "", "", "", "");
      ...
      protected void standaloneNotModal( )
      {
         ...
         AV68Pgmname = "Trn_ProductService";
         AssignAttri("", false, "AV68Pgmname", AV68Pgmname);
         Gx_BScreen = 0;
      ...
      protected void gxLoad_54( Guid A42SupplierGenId )
      {
         /* Using cursor T00089 */
      ...
      protected void gxLoad_55( Guid A49SupplierAgbId )
      {
      ...
      protected void BeforeComplete0868( )
      {
         ...
         GXt_SdtSDT_TrnAttributes6 = AV66SDT_TrnAttributes;
         new prc_addproductserviceattributestosdt(context ).execute(  A58ProductServiceId, out  GXt_SdtSDT_TrnAttributes6) ;
         AV66SDT_TrnAttributes = GXt_SdtSDT_TrnAttributes6;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254818394386", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_productservice.js", "?20254818394391", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      private GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationMetadata AV64WWPNotificationMetadataSDT ;
