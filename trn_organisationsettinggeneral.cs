...
namespace GeneXus.Programs {
   public class trn_organisationsettinggeneral : GXWebComponent
   {
      ...
      protected void RF3R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A11OrganisationId = H003R2_A11OrganisationId[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532622562124", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_organisationsettinggeneral.js", "?202532622562124", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","""{"handler":"E133R2","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A100OrganisationSettingid","fld":"ORGANISATIONSETTINGID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E143R2","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A100OrganisationSettingid","fld":"ORGANISATIONSETTINGID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_organisationsettinggeneral__default(),
            new Object[][] {
                new Object[] {
               H003R2_A100OrganisationSettingid, H003R2_A105OrganisationSettingLanguage, H003R2_A103OrganisationSettingBaseColor, H003R2_A11OrganisationId, H003R2_A104OrganisationSettingFontSize, H003R2_A40001OrganisationSettingFavicon_GXI, H003R2_A40000OrganisationSettingLogo_GXI, H003R2_A102OrganisationSettingFavicon, H003R2_A101OrganisationSettingLogo
               }
            }
         );
         AV25Pgmname = "Trn_OrganisationSettingGeneral";
