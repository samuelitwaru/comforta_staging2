   ...
   public class trn_productserviceloaddvcombo : GXProcedure
   {
      ...
      protected void S141( )
      {
         ...
         while ( (pr_default.getStatus(4) != 101) )
         {
            ...
            A11OrganisationId = P006X6_A11OrganisationId[0];
            n11OrganisationId = P006X6_n11OrganisationId[0];
         ...
         if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
         {
            ...
            {
               A11OrganisationId = P006X7_A11OrganisationId[0];
               n11OrganisationId = P006X7_n11OrganisationId[0];
               A29LocationId = P006X7_A29LocationId[0];
               A58ProductServiceId = P006X7_A58ProductServiceId[0];
               A42SupplierGenId = P006X7_A42SupplierGenId[0];
               n42SupplierGenId = P006X7_n42SupplierGenId[0];
      ...
      public override void initialize( )
      {
         ...
         P006X6_n11OrganisationId = new bool[] {false} ;
         ...
         P006X7_A29LocationId = new Guid[] {Guid.Empty} ;
         P006X7_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         P006X7_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         P006X7_n42SupplierGenId = new bool[] {false} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_productserviceloaddvcombo__default(),
            new Object[][] {
               ...
               , new Object[] {
               P006X6_A42SupplierGenId, P006X6_A11OrganisationId, P006X6_n11OrganisationId, P006X6_A44SupplierGenCompanyName
               }
               , new Object[] {
               P006X7_A11OrganisationId, P006X7_A29LocationId, P006X7_A58ProductServiceId, P006X7_A42SupplierGenId, P006X7_n42SupplierGenId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] P006X6_n11OrganisationId ;
      ...
      private Guid[] P006X7_A29LocationId ;
      private Guid[] P006X7_A58ProductServiceId ;
      private Guid[] P006X7_A42SupplierGenId ;
      private bool[] P006X7_n42SupplierGenId ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P006X6", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP006X6,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P006X7", "SELECT OrganisationId, LocationId, ProductServiceId, SupplierGenId FROM Trn_ProductService WHERE ProductServiceId = :AV20ProductServiceId and LocationId = :AV31LocationId and OrganisationId = :AV30OrganisationId ORDER BY ProductServiceId, LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP006X7,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
