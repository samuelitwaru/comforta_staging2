...
namespace GeneXus.Programs {
   public class trn_resident : GXDataArea
   {
      ...
      protected void gxLoad_69( Guid A527ResidentPackageId )
      {
         ...
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( A528SG_LocationId.ToString())+"\""+","+"\""+GXUtil.EncodeJSConstant( A529SG_OrganisationId.ToString())+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(10) == 101) )
         {
            AddString( ",") ;
      ...
      protected void CheckOptimisticConcurrency0964( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( Z96ResidentTypeId != T00092_A96ResidentTypeId[0] ) || ( Z98MedicalIndicationId != T00092_A98MedicalIndicationId[0] ) || ( Z527ResidentPackageId != T00092_A527ResidentPackageId[0] ) )
            {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(14, new Object[] {A62ResidentId, A312ResidentCountry, A431ResidentHomePhoneCode, A347ResidentPhoneCode, A66ResidentInitials, A70ResidentPhone, A430ResidentHomePhone, A314ResidentZipCode, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A67ResidentEmail, A68ResidentGender, A313ResidentCity, A315ResidentAddressLine1, A316ResidentAddressLine2, A73ResidentBirthDate, A71ResidentGUID, A348ResidentPhoneNumber, A432ResidentHomePhoneNumber, n445ResidentImage, A445ResidentImage, n40000ResidentImage_GXI, A40000ResidentImage_GXI, A29LocationId, A11OrganisationId, n96ResidentTypeId, A96ResidentTypeId, n98MedicalIndicationId, A98MedicalIndicationId, n527ResidentPackageId, A527ResidentPackageId});
                     pr_default.close(14);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(15, new Object[] {A312ResidentCountry, A431ResidentHomePhoneCode, A347ResidentPhoneCode, A66ResidentInitials, A70ResidentPhone, A430ResidentHomePhone, A314ResidentZipCode, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A67ResidentEmail, A68ResidentGender, A313ResidentCity, A315ResidentAddressLine1, A316ResidentAddressLine2, A73ResidentBirthDate, A71ResidentGUID, A348ResidentPhoneNumber, A432ResidentHomePhoneNumber, n96ResidentTypeId, A96ResidentTypeId, n98MedicalIndicationId, A98MedicalIndicationId, n527ResidentPackageId, A527ResidentPackageId, A62ResidentId, A29LocationId, A11OrganisationId});
                     pr_default.close(15);
                     pr_default.SmartCacheProvider.SetUpdated("Trn_Resident");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532622562933", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_resident.js", "?202532622562936", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void XC_49_0964( GeneXus.Programs.wwpbaseobjects.SdtAuditingObject AV42AuditingObject ,
                                 Guid A62ResidentId ,
                                 Guid A29LocationId ,
                                 Guid A11OrganisationId ,
                                 string Gx_mode )
      ...
      protected void XC_50_0964( GeneXus.Programs.wwpbaseobjects.SdtAuditingObject AV42AuditingObject ,
                                 Guid A62ResidentId ,
                                 Guid A29LocationId ,
                                 Guid A11OrganisationId ,
                                 string Gx_mode )
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_RESIDENTPACKAGEID","""{"handler":"Valid_Residentpackageid","iparms":[{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A529SG_OrganisationId","fld":"SG_ORGANISATIONID"}]""");
         setEventMetadata("VALID_RESIDENTPACKAGEID",""","oparms":[{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A529SG_OrganisationId","fld":"SG_ORGANISATIONID"}]}""");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_resident__default(),
            new Object[][] {
               ...
               T00092_A432ResidentHomePhoneNumber, T00092_A40000ResidentImage_GXI, T00092_n40000ResidentImage_GXI, T00092_A29LocationId, T00092_A11OrganisationId, T00092_A96ResidentTypeId, T00092_n96ResidentTypeId, T00092_A98MedicalIndicationId, T00092_n98MedicalIndicationId, T00092_A527ResidentPackageId,
               T00092_n527ResidentPackageId, T00092_A445ResidentImage, T00092_n445ResidentImage
               }
               , new Object[] {
               ...
               T00093_A432ResidentHomePhoneNumber, T00093_A40000ResidentImage_GXI, T00093_n40000ResidentImage_GXI, T00093_A29LocationId, T00093_A11OrganisationId, T00093_A96ResidentTypeId, T00093_n96ResidentTypeId, T00093_A98MedicalIndicationId, T00093_n98MedicalIndicationId, T00093_A527ResidentPackageId,
               T00093_n527ResidentPackageId, T00093_A445ResidentImage, T00093_n445ResidentImage
               }
               , new Object[] {
               ...
               , new Object[] {
               T00097_A528SG_LocationId, T00097_A529SG_OrganisationId
               }
               , new Object[] {
               ...
               T00098_A99MedicalIndicationName, T00098_A348ResidentPhoneNumber, T00098_A432ResidentHomePhoneNumber, T00098_A40000ResidentImage_GXI, T00098_n40000ResidentImage_GXI, T00098_A29LocationId, T00098_A11OrganisationId, T00098_A96ResidentTypeId, T00098_n96ResidentTypeId, T00098_A98MedicalIndicationId,
               T00098_n98MedicalIndicationId, T00098_A527ResidentPackageId, T00098_n527ResidentPackageId, T00098_A528SG_LocationId, T00098_A529SG_OrganisationId, T00098_A445ResidentImage, T00098_n445ResidentImage
               }
               , new Object[] {
               ...
               , new Object[] {
               T000912_A528SG_LocationId, T000912_A529SG_OrganisationId
               }
               , new Object[] {
               ...
               , new Object[] {
               T000922_A528SG_LocationId, T000922_A529SG_OrganisationId
               }
               , new Object[] {
               T000923_A549MemoId
               }
