...
namespace GeneXus.Programs {
   public class wp_organisationgeneralsuppliers : GXDataArea
   {
      ...
      protected void RF6H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A11OrganisationId = H006H2_A11OrganisationId[0];
               n11OrganisationId = H006H2_n11OrganisationId[0];
               A254SupplierGenTypeName = H006H2_A254SupplierGenTypeName[0];
               /* Execute user event: Grid.Load */
               E206H2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253262321381", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_organisationgeneralsuppliers.js", "?20253262321383", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H006H2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H006H2_n11OrganisationId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_organisationgeneralsuppliers__default(),
            new Object[][] {
                new Object[] {
               H006H2_A42SupplierGenId, H006H2_A501SupplierGenEmail, H006H2_A354SupplierGenPhoneNumber, H006H2_A353SupplierGenPhoneCode, H006H2_A48SupplierGenContactPhone, H006H2_A47SupplierGenContactName, H006H2_A311SupplierGenAddressLine2, H006H2_A310SupplierGenAddressLine1, H006H2_A259SupplierGenAddressZipCode, H006H2_A260SupplierGenAddressCity,
               H006H2_A309SupplierGenAddressCountry, H006H2_A254SupplierGenTypeName, H006H2_A253SupplierGenTypeId, H006H2_A44SupplierGenCompanyName, H006H2_A43SupplierGenKvkNumber, H006H2_A11OrganisationId, H006H2_n11OrganisationId
               }
               , new Object[] {
      ...
      private Guid[] H006H2_A11OrganisationId ;
      private bool[] H006H2_n11OrganisationId ;
