...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_OneSignalCustomBody.headings" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_OneSignalCustomBody.headings", Namespace="Comforta_version20")]
