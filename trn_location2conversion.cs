...
namespace GeneXus.Programs {
   public class trn_location2conversion : GXProcedure
   {
      public trn_location2conversion( )
      {
      ...
      public trn_location2conversion( IGxContext context )
      {
      ...
      public override void initialize( )
      {
         ...
         AV6OrganisationId = Guid.Empty;
         Gx_emsg = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_location2conversion__default(),
            new Object[][] {
                new Object[] {
   ...
   public class trn_location2conversion__default : DataStoreHelperBase, IDataStoreHelper
   {
