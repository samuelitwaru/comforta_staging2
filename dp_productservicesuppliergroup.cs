...
namespace GeneXus.Programs {
   public class dp_productservicesuppliergroup : GXProcedure
   {
      ...
      {
         this.Gxm2rootcol = new GXBaseCollection<SdtSDT_ProductServiceSupplierGroup_SDT_ProductServiceSupplierGroupItem>( context, "SDT_ProductServiceSupplierGroupItem", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
