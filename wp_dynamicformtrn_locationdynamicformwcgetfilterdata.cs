...
namespace GeneXus.Programs {
   public class wp_dynamicformtrn_locationdynamicformwcgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV34GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "WP_DynamicFormTrn_LocationDynamicFormWCGridState"), null, "", "");
         }
         else
         {
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_dynamicformtrn_locationdynamicformwcgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00E02_A240WWPFormType, P00E02_A209WWPFormTitle, P00E02_A231WWPFormDate, P00E02_A207WWPFormVersionNumber, P00E02_A208WWPFormReferenceName, P00E02_A206WWPFormId, P00E02_A366LocationDynamicFormId, P00E02_A11OrganisationId, P00E02_A29LocationId
               }
               , new Object[] {
               P00E03_A240WWPFormType, P00E03_A207WWPFormVersionNumber, P00E03_A231WWPFormDate, P00E03_A208WWPFormReferenceName, P00E03_A209WWPFormTitle, P00E03_A206WWPFormId, P00E03_A366LocationDynamicFormId, P00E03_A11OrganisationId, P00E03_A29LocationId
               }
            }
         );
         /* GeneXus formulas. */
