   ...
   public class trn_productservicegeneral : GXWebComponent
   {
      ...
      protected void WB4P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtProductServiceTileName_Internalname, StringUtil.RTrim( A266ProductServiceTileName), StringUtil.RTrim( context.localUtil.Format( A266ProductServiceTileName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,27);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductServiceTileName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProductServiceTileName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_ProductServiceGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtProductServiceGroup_Internalname, A338ProductServiceGroup, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", 0, edtProductServiceGroup_Visible, edtProductServiceGroup_Enabled, 0, 80, "chr", 5, "row", 0, StyleString, ClassString, "", "", "400", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Trn_ProductServiceGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table1_66_4P2( true) ;
         }
         else
         {
            wb_table1_66_4P2( false) ;
         }
         return  ;
      }

      protected void wb_table1_66_4P2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "start", "top", "", "", "div");
            wb_table2_84_4P2( true) ;
         }
         else
         {
            wb_table2_84_4P2( false) ;
         }
         return  ;
      }

      protected void wb_table2_84_4P2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "start", "top", "", "", "div");
            wb_table3_105_4P2( true) ;
         }
         else
         {
            wb_table3_105_4P2( false) ;
         }
         return  ;
      }

      protected void wb_table3_105_4P2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "start", "top", "", "", "div");
            wb_table4_123_4P2( true) ;
         }
         else
         {
            wb_table4_123_4P2( false) ;
         }
         return  ;
      }

      protected void wb_table4_123_4P2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void wb_table4_123_4P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table4_123_4P2e( true) ;
         }
         else
         {
            wb_table4_123_4P2e( false) ;
         }
      }

      protected void wb_table3_105_4P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_105_4P2e( true) ;
         }
         else
         {
            wb_table3_105_4P2e( false) ;
         }
      }

      protected void wb_table2_84_4P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_84_4P2e( true) ;
         }
         else
         {
            wb_table2_84_4P2e( false) ;
         }
      }

      protected void wb_table1_66_4P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_66_4P2e( true) ;
         }
         else
         {
            wb_table1_66_4P2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532622505973", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_productservicegeneral.js", "?202532622505974", false, true);
         context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
         context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_productservicegeneral__default(),
            new Object[][] {
               ...
               , new Object[] {
               H004P3_A58ProductServiceId, H004P3_A29LocationId, H004P3_A11OrganisationId, H004P3_A49SupplierAgbId, H004P3_n49SupplierAgbId, H004P3_A42SupplierGenId, H004P3_n42SupplierGenId, H004P3_A60ProductServiceDescription, H004P3_A51SupplierAgbName, H004P3_A44SupplierGenCompanyName,
               H004P3_A338ProductServiceGroup, H004P3_A370ProductServiceClass, H004P3_A40000ProductServiceImage_GXI, H004P3_A266ProductServiceTileName, H004P3_A59ProductServiceName, H004P3_A61ProductServiceImage
               }
            }
         );
         AV32Pgmname = "Trn_ProductServiceGeneral";
