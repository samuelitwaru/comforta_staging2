...
namespace GeneXus.Programs.wwpbaseobjects.discussions {
   ...
   [XmlType(TypeName =  "WWP_DiscussionMessage" , Namespace = "Comforta_version20" )]
   [Serializable]
   ...
   [DataContract(Name = @"WWPBaseObjects\Discussions\WWP_DiscussionMessage", Namespace = "Comforta_version20")]
