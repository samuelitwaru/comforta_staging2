...
namespace GeneXus.Programs.wwpbaseobjects.discussions {
   ...
   [XmlType(TypeName =  "WWP_DiscussionMessageMention" , Namespace = "Comforta_version20" )]
   [Serializable]
   ...
   [DataContract(Name = @"WWPBaseObjects\Discussions\WWP_DiscussionMessageMention", Namespace = "Comforta_version20")]
