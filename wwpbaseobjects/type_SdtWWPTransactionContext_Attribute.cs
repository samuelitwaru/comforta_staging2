...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="WWPTransactionContext.Attribute" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"WWPTransactionContext.Attribute", Namespace="Comforta_version20")]
