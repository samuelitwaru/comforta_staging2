...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   ...
   [XmlType(TypeName =  "WWP_Subscription" , Namespace = "Comforta_version20" )]
   [Serializable]
   ...
   [DataContract(Name = @"WWPBaseObjects\Subscriptions\WWP_Subscription", Namespace = "Comforta_version20")]
