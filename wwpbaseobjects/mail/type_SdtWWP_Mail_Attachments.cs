...
namespace GeneXus.Programs.wwpbaseobjects.mail {
   ...
   [XmlType(TypeName =  "WWP_Mail.Attachments" , Namespace = "Comforta_version20" )]
   [Serializable]
   ...
   [DataContract(Name = @"WWPBaseObjects\Mail\WWP_Mail.Attachments", Namespace = "Comforta_version20")]
