...
namespace GeneXus.Programs.wwpbaseobjects.notifications.web {
   ...
   [XmlType(TypeName =  "WWP_WebClient" , Namespace = "Comforta_version20" )]
   [Serializable]
   ...
   [DataContract(Name = @"WWPBaseObjects\Notifications\Web\WWP_WebClient", Namespace = "Comforta_version20")]
