...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   ...
   [XmlType(TypeName =  "WWP_Notification" , Namespace = "Comforta_version20" )]
   [Serializable]
   ...
   [DataContract(Name = @"WWPBaseObjects\Notifications\Common\WWP_Notification", Namespace = "Comforta_version20")]
