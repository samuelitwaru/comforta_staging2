...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   public class wwp_updatenotificationdefinitions : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         AV10WWP_NotificationDefinitionCollection = new GXBCCollection<GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_NotificationDefinition>( context, "WWP_NotificationDefinition", "Comforta_version20");
         GXt_objcol_SdtWWP_NotificationDefinition1 = new GXBCCollection<GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_NotificationDefinition>( context, "WWP_NotificationDefinition", "Comforta_version20");
