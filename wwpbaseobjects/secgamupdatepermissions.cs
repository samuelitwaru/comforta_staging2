...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secgamupdatepermissions : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         AV27SecGAMFunctionalitiesToLoadCollection = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtSecGAMFunctionalitiesToLoad>( context, "SecGAMFunctionalitiesToLoad", "Comforta_version20");
         GXt_objcol_SdtSecGAMFunctionalitiesToLoad1 = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtSecGAMFunctionalitiesToLoad>( context, "SecGAMFunctionalitiesToLoad", "Comforta_version20");
