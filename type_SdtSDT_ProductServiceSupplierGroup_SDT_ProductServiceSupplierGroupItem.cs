...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_ProductServiceSupplierGroupItem" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_ProductServiceSupplierGroupItem", Namespace="Comforta_version20")]
