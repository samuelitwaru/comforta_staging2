...
namespace GeneXus.Programs {
   public class prc_addtodynamictransalation : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         Gx_emsg = "";
         GXt_char1 = "";
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.prc_addtodynamictransalation__datastore1(),
            new Object[][] {
            }
         );
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.prc_addtodynamictransalation__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_addtodynamictransalation__default(),
            new Object[][] {
                new Object[] {
   ...
   public class prc_addtodynamictransalation__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class prc_addtodynamictransalation__gam : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
...
public class prc_addtodynamictransalation__default : DataStoreHelperBase, IDataStoreHelper
{
   public ICursor[] getCursors( )
   {
      cursorDefinitions();
