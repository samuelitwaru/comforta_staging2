...
namespace GeneXus.Programs {
   public class prc_gettranslatedchart : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A586DiscussionTranslationWWPDiscus = P00EL2_A586DiscussionTranslationWWPDiscus[0];
            A595DiscussionTranslationEnglish = P00EL2_A595DiscussionTranslationEnglish[0];
            A596DiscussionTranslationDutch = P00EL2_A596DiscussionTranslationDutch[0];
            A585Trn_DiscussionTranslationId = P00EL2_A585Trn_DiscussionTranslationId[0];
      ...
      public override void initialize( )
      {
         ...
         AV10Language = "";
         P00EL2_A586DiscussionTranslationWWPDiscus = new long[1] ;
         P00EL2_A595DiscussionTranslationEnglish = new string[] {""} ;
         P00EL2_A596DiscussionTranslationDutch = new string[] {""} ;
         P00EL2_A585Trn_DiscussionTranslationId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_gettranslatedchart__default(),
            new Object[][] {
                new Object[] {
               P00EL2_A586DiscussionTranslationWWPDiscus, P00EL2_A595DiscussionTranslationEnglish, P00EL2_A596DiscussionTranslationDutch, P00EL2_A585Trn_DiscussionTranslationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P00EL2_A586DiscussionTranslationWWPDiscus ;
      private string[] P00EL2_A595DiscussionTranslationEnglish ;
      private string[] P00EL2_A596DiscussionTranslationDutch ;
      private Guid[] P00EL2_A585Trn_DiscussionTranslationId ;
   ...
   public class prc_gettranslatedchart__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00EL2", "SELECT DiscussionTranslationWWPDiscus, DiscussionTranslationEnglish, DiscussionTranslationDutch, Trn_DiscussionTranslationId FROM Trn_DiscussionTranslation WHERE DiscussionTranslationWWPDiscus = :AV8WWPDiscussionMessageId ORDER BY DiscussionTranslationWWPDiscus ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00EL2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
