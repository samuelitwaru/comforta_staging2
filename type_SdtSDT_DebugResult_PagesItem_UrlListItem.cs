...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_DebugResult.PagesItem.UrlListItem" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_DebugResult.PagesItem.UrlListItem", Namespace="Comforta_version20")]
