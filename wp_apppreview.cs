...
namespace GeneXus.Programs {
   public class wp_apppreview : GXHttpHandler
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253271252261", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wp_apppreview.js", "?20253271252262", false, true);
            context.AddJavascriptSource("UserControls/UC_AppPreviewRender.js", "", false, true);
         }
