...
namespace GeneXus.Programs {
   public class wp_dynamicformtrn_organisationdynamicformwc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV52OrderedBy, AV54OrderedDsc, AV23FilterFullText, AV10WWPFormType, AV75WWPContext, AV47ManageFiltersExecutionStep, AV12ColumnsSelector, AV80Pgmname, AV67TFWWPFormTitle, AV68TFWWPFormTitle_Sel, AV65TFWWPFormReferenceName, AV66TFWWPFormReferenceName_Sel, AV61TFWWPFormDate, AV62TFWWPFormDate_To, AV69TFWWPFormVersionNumber, AV70TFWWPFormVersionNumber_To, AV63TFWWPFormLatestVersionNumber, AV64TFWWPFormLatestVersionNumber_To, AV78WWPFormIsForDynamicValidations, AV42IsAuthorized_UserActionEdit, AV41IsAuthorized_UserActionDisplay, AV39IsAuthorized_UserActionCopy, AV40IsAuthorized_UserActionDelete, AV43IsAuthorized_UserActionFilledForms, AV44IsAuthorized_UserActionFillOutForm, AV36IsAuthorized_UCopyToLocation, AV37IsAuthorized_UDirectCopyToLocation, AV55OrganisationIdFilter, AV5LocationId, A509OrganisationDynamicFormId, sPrefix) ;
      ...
      protected void WBBA0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV23FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV23FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,30);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WWPFullTextFilter", "start", true, "", "HLP_WP_DynamicFormTrn_OrganisationDynamicFormWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector AV12ColumnsSelector ,
                                       string AV80Pgmname ,
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         /* Using cursor H00BA3 */
         pr_default.execute(1, new Object[] {AV10WWPFormType, lV67TFWWPFormTitle, AV68TFWWPFormTitle_Sel, lV65TFWWPFormReferenceName, AV66TFWWPFormReferenceName_Sel, AV61TFWWPFormDate, AV62TFWWPFormDate_To, AV69TFWWPFormVersionNumber, AV70TFWWPFormVersionNumber_To});
      ...
      protected void RFBA2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV65TFWWPFormReferenceName = StringUtil.Concat( StringUtil.RTrim( AV65TFWWPFormReferenceName), "%", "");
            /* Using cursor H00BA4 */
            pr_default.execute(2, new Object[] {AV10WWPFormType, lV67TFWWPFormTitle, AV68TFWWPFormTitle_Sel, lV65TFWWPFormReferenceName, AV66TFWWPFormReferenceName_Sel, AV61TFWWPFormDate, AV62TFWWPFormDate_To, AV69TFWWPFormVersionNumber, AV70TFWWPFormVersionNumber_To});
            nGXsfl_43_idx = 1;
            sGXsfl_43_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_43_idx), 4, 0), 4, "0");
            SubsflControlProps_432( ) ;
            GRID_nEOF = 0;
      ...
      protected void STRUPBA0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vWWPCONTEXT"), AV75WWPContext);
            /* Read saved values. */
      ...
      protected void E21BA2( )
      {
         ...
         edtWWPFormTitle_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV12ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtWWPFormReferenceName_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV12ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtWWPFormDate_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV12ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtWWPFormVersionNumber_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV12ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtWWPFormLatestVersionNumber_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV12ColumnsSelector.gxTpr_Columns.Item(5)).gxTpr_Isvisible ? 1 : 0);
      ...
      protected void E16BA2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "WP_DynamicFormTrn_OrganisationDynamicFormWCColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV14ColumnsSelectorXML)) ? "" : AV12ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E11BA2( )
      {
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "WP_DynamicFormTrn_OrganisationDynamicFormWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV80Pgmname+"GridState",  AV48ManageFiltersXml) ;
      ...
      protected void S182( )
      {
         ...
         returnInSub = false;
         AV12ColumnsSelector = new GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector(context);
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV12ColumnsSelector,  "WWPFormTitle",  "",  "Title",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV12ColumnsSelector,  "WWPFormReferenceName",  "",  "Reference Name",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV12ColumnsSelector,  "WWPFormDate",  "",  "Date",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV12ColumnsSelector,  "WWPFormVersionNumber",  "",  "Form Version #",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV12ColumnsSelector,  "WWPFormLatestVersionNumber",  "",  "Version Number",  true,  "") ;
         GXt_char3 = AV74UserCustomValue;
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "WP_DynamicFormTrn_OrganisationDynamicFormWCColumnsSelector", out  GXt_char3) ;
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV74UserCustomValue)) ) )
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.wwp_columnselector_updatecolumns(context ).execute( ref  AV13ColumnsSelectorAux, ref  AV12ColumnsSelector) ;
         }
      }
      ...
      protected void S122( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "WP_DynamicFormTrn_OrganisationDynamicFormWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item5) ;
            ...
            if ( ! (Guid.Empty==AV6OrganisationId) )
            {
               ...
               else
               {
                  ...
                  while ( AV84GXV3 <= AV83GXV2.Count )
                  {
                     ...
                     GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  AV49Message.gxTpr_Description,  "error",  "",  "false",  ""));
      ...
      protected void S142( )
      {
         ...
         {
            AV29GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV80Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S202( )
      {
         ...
         {
            AV30GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV29GridState.gxTpr_Filtervalues.Item(AV96GXV12));
         ...
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV68TFWWPFormTitle_Sel)),  AV68TFWWPFormTitle_Sel, out  GXt_char3) ;
         GXt_char6 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV66TFWWPFormReferenceName_Sel)),  AV66TFWWPFormReferenceName_Sel, out  GXt_char6) ;
         Ddo_grid_Selectedvalue_set = GXt_char3+"|"+GXt_char6+"|||";
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char6 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV67TFWWPFormTitle)),  AV67TFWWPFormTitle, out  GXt_char6) ;
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV65TFWWPFormReferenceName)),  AV65TFWWPFormReferenceName, out  GXt_char3) ;
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV29GridState,  "FILTERFULLTEXT",  context.GetMessage( "WWP_FullTextFilterDescription", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV23FilterFullText)),  0,  AV23FilterFullText,  AV23FilterFullText,  false,  "",  "") ;
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV80Pgmname+"GridState",  AV29GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254917243361", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_dynamicformtrn_organisationdynamicformwc.js", "?20254917243365", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV74UserCustomValue = "";
         AV13ColumnsSelectorAux = new GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector(context);
      ...
      private GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector AV12ColumnsSelector ;
      ...
      private GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector AV13ColumnsSelectorAux ;
