   ...
   public class wp_createorganisationandmanagerstep2 : GXWebComponent
   {
      ...
      protected void S122( )
      {
         ...
         while ( AV89GXV16 <= AV88GXV15.Count )
         {
            ...
            AV44Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253273241773", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_createorganisationandmanagerstep2.js", "?20253273241778", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV44Combo_DataItem ;
