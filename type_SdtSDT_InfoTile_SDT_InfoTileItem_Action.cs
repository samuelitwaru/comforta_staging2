...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_InfoTile.SDT_InfoTileItem.Action" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_InfoTile.SDT_InfoTileItem.Action", Namespace="Comforta_version20")]
