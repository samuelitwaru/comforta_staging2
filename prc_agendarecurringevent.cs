...
namespace GeneXus.Programs {
   public class prc_agendarecurringevent : GXProcedure
   {
                           ...
                           out GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item> aP4_CalendarEvents )
      {
         ...
         this.AV14CalendarEvents = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      {
         AV14CalendarEvents = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
