...
namespace GeneXus.Programs {
   public class prc_contentpagesapiv2 : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtSDT_ContentPage> aP2_SDT_ContentPageCollection )
      {
         ...
         this.AV4SDT_ContentPageCollection = new GXBaseCollection<SdtSDT_ContentPage>( context, "SDT_ContentPage", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      {
         AV4SDT_ContentPageCollection = new GXBaseCollection<SdtSDT_ContentPage>( context, "SDT_ContentPage", "Comforta_version20");
         /* GeneXus formulas. */
      }
