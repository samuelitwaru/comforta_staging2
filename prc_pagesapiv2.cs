   ...
   public class prc_pagesapiv2 : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            while ( (pr_default.getStatus(1) != 101) )
            {
               ...
               new prc_convertnewtooldmenustructure(context ).execute(  AV15SDT_MenuPage, out  GXt_SdtSDT_MobilePage1) ;
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_pagesapiv2__default(),
            new Object[][] {
                new Object[] {
               P00DL2_A523AppVersionId, P00DL2_A11OrganisationId, P00DL2_n11OrganisationId, P00DL2_A29LocationId, P00DL2_n29LocationId
               }
               , new Object[] {
               P00DL3_A523AppVersionId, P00DL3_A525PageType, P00DL3_A536PagePublishedStructure, P00DL3_A516PageId
               }
            }
         );
         /* GeneXus formulas. */
