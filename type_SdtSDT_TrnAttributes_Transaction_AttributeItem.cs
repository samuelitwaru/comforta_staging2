...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_TrnAttributes.Transaction.AttributeItem" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_TrnAttributes.Transaction.AttributeItem", Namespace="Comforta_version20")]
