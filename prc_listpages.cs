...
namespace GeneXus.Programs {
   public class prc_listpages : GXProcedure
   {
      ...
      {
         this.AV2SDT_PageStructureCollection = new GXBaseCollection<SdtSDT_PageStructure>( context, "SDT_PageStructure", "Comforta_version20") ;
      ...
      {
         AV2SDT_PageStructureCollection = new GXBaseCollection<SdtSDT_PageStructure>( context, "SDT_PageStructure", "Comforta_version20");
