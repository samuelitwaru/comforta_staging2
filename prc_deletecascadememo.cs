...
namespace GeneXus.Programs {
   public class prc_deletecascadememo : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A549MemoId = P00DY2_A549MemoId[0];
            A62ResidentId = P00DY2_A62ResidentId[0];
            A529SG_OrganisationId = P00DY2_A529SG_OrganisationId[0];
            A528SG_LocationId = P00DY2_A528SG_LocationId[0];
            /* Using cursor P00DY3 */
      ...
      public override void initialize( )
      {
         ...
         P00DY2_A549MemoId = new Guid[] {Guid.Empty} ;
         P00DY2_A62ResidentId = new Guid[] {Guid.Empty} ;
         P00DY2_A529SG_OrganisationId = new Guid[] {Guid.Empty} ;
         P00DY2_A528SG_LocationId = new Guid[] {Guid.Empty} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_deletecascadememo__default(),
            new Object[][] {
                new Object[] {
               P00DY2_A549MemoId, P00DY2_A62ResidentId, P00DY2_A529SG_OrganisationId, P00DY2_A528SG_LocationId
               }
               , new Object[] {
               }
            }
      ...
      private Guid[] P00DY2_A549MemoId ;
      private Guid[] P00DY2_A62ResidentId ;
      private Guid[] P00DY2_A529SG_OrganisationId ;
      private Guid[] P00DY2_A528SG_LocationId ;
   }
   ...
   public class prc_deletecascadememo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00DY2(context, (Guid)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00DY2", "scmdbuf",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00DY2,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00DY3", "SAVEPOINT gxupdate;DELETE FROM Trn_Memo  WHERE MemoId = :MemoId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00DY3)
          };
       }
    }
