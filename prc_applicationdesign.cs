...
namespace GeneXus.Programs {
   public class prc_applicationdesign : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtSDT_Page> aP2_SDT_PageCollection )
      {
         ...
         this.AV4SDT_PageCollection = new GXBaseCollection<SdtSDT_Page>( context, "SDT_Page", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      public override void initialize( )
      {
         ...
         AV4SDT_PageCollection = new GXBaseCollection<SdtSDT_Page>( context, "SDT_Page", "Comforta_version20");
         /* GeneXus formulas. */
      }
