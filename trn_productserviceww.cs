...
namespace GeneXus.Programs {
   public class trn_productserviceww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector AV68ColumnsSelector ,
                                       string AV82Pgmname ,
      ...
      protected void E194N2( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Success",  AV80successmsg,  "success",  "",  "true",  ""));
      ...
      protected void E204N2( )
      {
         ...
         edtProductServiceName_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV68ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtProductServiceTileName_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV68ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         ...
         cmbProductServiceClass.Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV68ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavSuppliergroup_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV68ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible ? 1 : 0);
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV82Pgmname, out  GXt_char5) ;
      ...
      protected void E164N2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "Trn_ProductServiceWWColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV66ColumnsSelectorXML)) ? "" : AV68ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void S172( )
      {
         ...
         returnInSub = false;
         AV68ColumnsSelector = new GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector(context);
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV68ColumnsSelector,  "ProductServiceName",  "",  "Name",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV68ColumnsSelector,  "ProductServiceTileName",  "",  "Tile Name",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV68ColumnsSelector,  "ProductServiceClass",  "",  "Category",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV68ColumnsSelector,  "&SupplierGroup",  "",  "Supplier",  true,  "") ;
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV67UserCustomValue)) ) )
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.wwp_columnselector_updatecolumns(context ).execute( ref  AV69ColumnsSelectorAux, ref  AV68ColumnsSelector) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253262312862", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_productserviceww.js", "?20253262312865", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      private GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector AV68ColumnsSelector ;
