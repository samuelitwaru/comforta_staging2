...
namespace GeneXus.Programs {
   public class trn_template_dataprovider : GXProcedure
   {
      ...
      {
         this.AV2ReturnValue = new GXBCCollection<SdtTrn_Template>( context, "Trn_Template", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      {
         AV2ReturnValue = new GXBCCollection<SdtTrn_Template>( context, "Trn_Template", "Comforta_version20");
         /* GeneXus formulas. */
      }
